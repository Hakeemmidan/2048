...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__game__ = __webpack_require__(9);
        ...
        window.onload = function () {
            ...
            let game = new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* Game */](GAME_HEIGHT, CELL_HEIGHT, padding)
            game.start()
            game.addCell()
...
/***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        "use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__background__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__input__ = __webpack_require__(12);
        ...
        class Game {
            ...
            start() {
                this.background = new __WEBPACK_IMPORTED_MODULE_0__background__["a" /* Background */](this)
            ...
            addCell() {
                ...
                setTimeout(() => {
                    ...
                    let newCell = new __WEBPACK_IMPORTED_MODULE_1__cell__["a" /* Cell */](id, that, randomLocation, randomValue)
                    that.gameMovingObjects.push(newCell)
                    new __WEBPACK_IMPORTED_MODULE_2__input__["a" /* InputHandler */](newCell)
                }, 100);
            }
            ...
            mergeCells(cell1, cell2, location) {
                const id = this.generateCellId()
                const newCell = new __WEBPACK_IMPORTED_MODULE_1__cell__["a" /* Cell */](id, this, location, cell1.value + cell2.value)
...
/* harmony export (immutable) */ __webpack_exports__["a"] = InputHandler;
